...
class BertConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        remove_qk=False,
        remove_position_embeddings=False,
        attention_head_size=-1,
        qk="linear",
        value_forward="feedforward",
        **kwargs
    ):
        ...
        self.remove_qk = remove_qk
        self.remove_position_embeddings = remove_position_embeddings
        self.attention_head_size = attention_head_size
        self.qk = qk
        self.value_forward = value_forward
